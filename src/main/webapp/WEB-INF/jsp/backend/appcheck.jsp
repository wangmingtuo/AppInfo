  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content1">
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath }/backend/checksave" method="post">
           ...
           <div class="item form-group">
            ...
            <c:choose> 
			  ...
			  <c:otherwise>   
			    ...
			    <a href="${appVersion.downloadLink}" onclick="UpdateSize(${appInfo.id});">下载</a>
			    </p>
			  </c:otherwise> 
            </c:choose> 
            </div>
