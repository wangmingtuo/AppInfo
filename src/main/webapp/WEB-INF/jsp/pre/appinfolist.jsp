...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="${pageContext.request.contextPath }/dev/list">
	...
	<div class="x_panel">
		<div class="x_content">
			...
			<div id="datatable-responsive_wrapper"
				...
				<div class="row">
					<div class="col-sm-12">
					<a href="${pageContext.request.contextPath}/dev/getAppinfoadd" class="btn btn-success btn-sm">新增APP基础信息</a>
					<button id="js-export"  type="button" class="btn btn-primary">导出Excel</button>	
					<input type="hidden" id="currentPageNo" value="${pages.currentPageNo}"/>
					<button id="js-exportAll"  type="button" class="btn btn-primary">导出全部数据</button>	
							...
							<ul class="pagination">
								<c:if test="${pages.currentPageNo > 1}">
									<li class="paginate_button previous"><a
										href="${pageContext.request.contextPath }/dev/list?
										querySoftwareName=${querySoftwareName}&queryStatus=${queryStatus}&
										queryCategoryLevel1=${queryCategoryLevel1}&queryCategoryLevel2=${queryCategoryLevel2}&
										queryCategoryLevel3=${queryCategoryLevel3}&queryFlatformId=${queryFlatformId}&
										devId=${devId}&currentPageNo=1"
									...
									<li class="paginate_button "><a
										...
										queryCategoryLevel1=${queryCategoryLevel1}&queryCategoryLevel2=${queryCategoryLevel2}&
										queryCategoryLevel3=${queryCategoryLevel3}&queryFlatformId=${queryFlatformId}&
										devId=${devId}&currentPageNo=${pages.currentPageNo-1}"
								...
								<c:if test="${pages.currentPageNo < pages.totalPageCount }">
									...
									<li class="paginate_button next"><a
										...
										queryCategoryLevel1=${queryCategoryLevel1}&queryCategoryLevel2=${queryCategoryLevel2}&
										queryCategoryLevel3=${queryCategoryLevel3}&queryFlatformId=${queryFlatformId}&
										devId=${devId}&currentPageNo=${pages.totalPageCount }"
