			...
			<div class="col-md-3 left_col menu_fixed">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="${pageContext.request.contextPath }/dev/main" class="site_title">
							<i class="fa fa-paw"></i> 
							<span>APP BMS</span>
						</a>
					</div>
					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								<li>
									<a>
										<i class="fa fa-home"></i> APP账户管理 
										<span class="fa fa-chevron-down"></span>
									</a>
									<ul class="nav child_menu">
										<li>
											<a href="javascript:;">APP开发者账户申请</a>
										</li>
										<li>
											<a href="javascript:;">个人账户信息维护</a>
										</li>
									</ul>
								</li>
								<li>
									<a>
										<i class="fa fa-edit"></i> APP应用管理
										<span class="fa fa-chevron-down"></span>
									</a>
									<ul class="nav child_menu">
										<li>
										<a href="${pageContext.request.contextPath }/dev/list">APP维护</a>
										</li>
									</ul>
					...
					<div class="sidebar-footer hidden-small">
						<a data-toggle="tooltip" data-placement="top" title="Settings">
							...
							href="${pageContext.request.contextPath }/login/LoginoOut"> <span
						...
						<ul class="nav navbar-nav navbar-right">
							<li class=""><a href="javascript:;"
								...
								<ul class="dropdown-menu dropdown-usermenu pull-right">
									<li><a
										href="${pageContext.request.contextPath }/login/LoginoOut"><i
